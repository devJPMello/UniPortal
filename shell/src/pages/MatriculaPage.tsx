...
const MatriculaApp = lazy(() => import('mfe_matricula/MatriculaApp'))
    ...
    if (this.state.error)
      return (
        <div className="mfe-error">
          ...
          <p>Certifique-se de que o serviço está rodando em <code>localhost:3002</code>.</p>
  ...
  return (
    <div className="mfe-container">
      ...
      <MfeErrorBoundary name="Matrícula">
        <Suspense fallback={<MfeFallback name="Matrícula" />}>
          <MatriculaApp token={token ?? undefined} />
        </Suspense>
      </MfeErrorBoundary>
    </div>
  )
