...
const BibliotecaApp = lazy(() => import('mfe_biblioteca/BibliotecaApp'))
    ...
    if (this.state.error)
      return (
        <div className="mfe-error">
          ...
          <p>Certifique-se de que o serviço está rodando em <code>localhost:3003</code>.</p>
  ...
  return (
    <div className="mfe-container">
      ...
      <MfeErrorBoundary name="Biblioteca">
        <Suspense fallback={<MfeFallback name="Biblioteca" />}>
          <BibliotecaApp token={token ?? undefined} />
        </Suspense>
      </MfeErrorBoundary>
    </div>
  )
